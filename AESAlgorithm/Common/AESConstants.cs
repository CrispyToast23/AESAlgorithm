namespace AESAlgorithm.Common
{
    public class AESConstants
    {
        ...
        internal static readonly byte[,] mixColumnsMatrix = new byte[4, 4]
        {
            { 0x02, 0x03, 0x01, 0x01 },
            { 0x01, 0x02, 0x03, 0x01 },
            { 0x01, 0x01, 0x02, 0x03 },
        ...
        internal static readonly byte[,] invMixColumnsMatrix = new byte[4, 4]
        {
            { 0x0E, 0x0B, 0x0D, 0x09 },
            { 0x09, 0x0E, 0x0B, 0x0D },
            { 0x0D, 0x09, 0x0E, 0x0B },
        ...
        internal static readonly byte[,] invSBox = new byte[16, 16]
        {
        ...
        internal byte[,] KeyExpansion(byte[] key)
        {
        ...
        internal byte[,] CopyInputToState(byte[] input, byte[,] state)
        {
        ...
        internal byte[] GetStateAsByteArray(byte[,] state)
        {
